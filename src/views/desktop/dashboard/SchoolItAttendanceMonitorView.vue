...
const activeDepartments = computed(() => props.preview ? previewState.departments : departments.value)
const activePrograms = computed(() => props.preview ? previewState.programs : programs.value)
const activeUsers = computed(() => props.preview ? previewState.users : users.value)
