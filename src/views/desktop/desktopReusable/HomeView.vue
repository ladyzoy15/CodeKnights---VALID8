<template>
  <div class="home-page">
    ...
    <div class="breadcrumbs-wrap dashboard-enter dashboard-enter--2">
      <Breadcrumbs />
    </div>
...
.search-shell {
  ...
  background: var(--aura-glass-bg, rgba(255, 255, 255, 0.7));
  ...
  border: 1px solid var(--aura-glass-border, rgba(255, 255, 255, 0.5));
}
