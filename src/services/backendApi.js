...
export async function getExcuseLetters(baseUrl, token, params = {}) {
    return await request(baseUrl, '/api/excuse-letters', {
        method: 'GET',
        token,
        params,
    })
...
export async function submitExcuseLetter(baseUrl, token, eventId, payload) {
    return await requestWithFallback(baseUrl, [`/api/events/${eventId}/excuse-letters`, `/api/excuse-letters/events/${eventId}`], {
        method: 'POST',
        token,
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(payload),
...
export async function reviewExcuseLetter(baseUrl, token, letterId, payload) {
    return await request(baseUrl, `/api/excuse-letters/${letterId}/review`, {
        method: 'PATCH',
        token,
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(payload),
