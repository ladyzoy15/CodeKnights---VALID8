...
.event-editor__title{margin:0;font-size:26px;font-weight:800;letter-spacing:-.04em;color:var(--color-text-primary)}
.event-editor__copy{margin:8px 0 0;font-size:13px;line-height:1.5;color:var(--color-text-secondary)}
.event-editor__close{width:42px;height:42px;border:none;border-radius:999px;background:var(--color-field-surface);color:var(--color-text-primary);display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0}
...
.event-editor__field-label{font-size:12px;font-weight:800;letter-spacing:.02em;color:var(--color-text-secondary);text-transform:uppercase}
.event-editor__field-input{width:100%;min-height:48px;padding:12px 16px;border:1px solid var(--color-surface-border);border-radius:18px;background:var(--color-field-surface);font-size:14px;font-weight:600;color:var(--color-text-primary);outline:none;box-sizing:border-box}
...
.event-editor__checkbox{display:flex;align-items:flex-start;gap:12px;font-size:14px;font-weight:600;line-height:1.5;color:var(--color-text-primary);cursor:pointer}
.event-editor__checkbox input{display:none}
.event-editor__checkbox-mark{position:relative;flex-shrink:0;width:22px;height:22px;border-radius:999px;border:1.5px solid var(--color-surface-border);background:var(--color-field-surface)}
.event-editor__checkbox input:checked + .event-editor__checkbox-mark::after{content:'';position:absolute;inset:5px;border-radius:999px;background:var(--color-primary)}
.event-editor__note{margin:0;font-size:12px;line-height:1.6;color:var(--color-text-secondary)}
...
.event-editor__secondary{background:var(--color-field-surface);color:var(--color-text-primary)}
.event-editor__primary{background:var(--color-primary);color:var(--color-primary-text)}
