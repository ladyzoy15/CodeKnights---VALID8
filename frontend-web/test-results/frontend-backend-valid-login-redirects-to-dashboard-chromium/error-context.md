...
- Name: frontend-backend.spec.js >> valid login redirects to dashboard
- Location: e2e\frontend-backend.spec.js:36:1
    ...
    - generic [ref=e9]:
      ...
      - generic [ref=e11]:
        - generic [ref=e12]:
          ...
          - textbox "Gmail" [ref=e14]: campus_admin@test.com
        - generic [ref=e15]:
          ...
          - button "Show password" [ref=e18]:
            - img [ref=e19]
        - paragraph [ref=e22]: Unable to reach the API. The server may be unavailable or the request may be blocked.
        - button "Log In" [ref=e23]
        - link "Forgot password?" [ref=e25] [cursor=pointer]:
          - /url: "#"
    - link "Learn more about Aura Project" [ref=e27] [cursor=pointer]:
      - /url: "#"
```
