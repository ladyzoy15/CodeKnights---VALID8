...
function createSsgPreviewBundle() {
  const students = [
    createStudent({
      ...
      firstName: 'Lea',
      lastName: 'Navarro',
      email: 'lea.navarro@preview.nexus',
      departmentId: 11,
    ...
    createStudent({
      ...
      firstName: 'Noel',
      lastName: 'Rivera',
      email: 'noel.rivera@preview.nexus',
      departmentId: 12,
    ...
    createStudent({
      ...
      firstName: 'Aya',
      lastName: 'Torres',
      email: 'aya.torres@preview.nexus',
      departmentId: 13,
    ...
    createStudent({
      ...
      firstName: 'Marco',
      lastName: 'Sison',
      email: 'marco.sison@preview.nexus',
      departmentId: 14,
    ...
    createStudent({
      ...
      firstName: 'Andre',
      lastName: 'Bello',
      email: 'andre.bello@preview.nexus',
      departmentId: 16,
  ...
  const currentUser = normalizeUserWithRelations({
    id: 5001,
    email: 'ssg.president@preview.nexus',
    first_name: 'Mira',
    last_name: 'Santos',
    school_id: PREVIEW_SCHOOL.school_id,
...
function createSgPreviewBundle() {
  const students = [
    createStudent({
      ...
      firstName: 'Janel',
      lastName: 'Mercado',
      email: 'janel.mercado@preview.nexus',
      departmentId: 11,
      departmentName: 'College of Engineering',
      programId: 111,
      programName: 'BS Computer Engineering',
    ...
    createStudent({
      ...
      firstName: 'Enzo',
      lastName: 'Quiambao',
      email: 'enzo.quiambao@preview.nexus',
      departmentId: 11,
      departmentName: 'College of Engineering',
      programId: 112,
    ...
    createStudent({
      ...
      firstName: 'Trina',
      lastName: 'Dizon',
      email: 'trina.dizon@preview.nexus',
      departmentId: 11,
      departmentName: 'College of Engineering',
      programId: 113,
    ...
    createStudent({
      ...
      firstName: 'Harvey',
      lastName: 'Lao',
      email: 'harvey.lao@preview.nexus',
      departmentId: 11,
      departmentName: 'College of Engineering',
      programId: 114,
    ...
    createStudent({
      ...
      firstName: 'Mina',
      lastName: 'Cabiles',
      email: 'mina.cabiles@preview.nexus',
      departmentId: 11,
      departmentName: 'College of Engineering',
      programId: 115,
  ...
  const currentUser = normalizeUserWithRelations({
    id: 6001,
    email: 'engineering.sg@preview.nexus',
    first_name: 'Paula',
    last_name: 'Reyes',
    school_id: PREVIEW_SCHOOL.school_id,
    school_name: PREVIEW_SCHOOL.school_name,
